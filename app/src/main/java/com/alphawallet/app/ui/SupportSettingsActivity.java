...
public class SupportSettingsActivity extends BaseActivity {
    ...
    private void initializeSettings() {
        ...
        xml = new SettingsItemView.Builder(this)
                .withIcon(R.drawable.ic_settings_tokenscript)
                .withTitle(R.string.title_xml)
                .withListener(this::onXmlClicked)
                .build();
    }
    ...
    private void addSettingsToLayout() {
        ...
        supportSettingsLayout.addView(xml);
    }
